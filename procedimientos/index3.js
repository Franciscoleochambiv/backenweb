const {taskOne,taskTwo,taskTree,lectura,firma,leefirma,envio,ticket,escribircdr}= require('./t4.js');

//const { correo } = require("./correo2");

async function anulafactura(
    rucemisor, 
    fecha_de_emision,
    fecha_actual,
    razonemisor,
  ...
  )
  {
    try{
      ...
      let firmadozip=archivosinfirma.slice(0, -6)+".zip";
        ...
        console.time('tiempo');
        const valor1=await taskOne(rucemisor, 
          fecha_de_emision,
          fecha_actual,
          razonemisor,
          Nrodocu,
