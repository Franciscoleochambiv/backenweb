...
notesCtrl.createNote = async (req, res) => {
    ...
    var buscadatotabla= Note.findOne({title:title},function callback(error,b){
       // console.log(buscadatotabla);
        ...
        if (error !==null){
         ...
         console.log("analizamos el resultado");
         ...
         // var contenido = res.applicationResponse;
          console.log("ponemos el contenido en una varable borramos");
        ...
        b.remove(err =>{
           ...
           /*
           var borra= Note.findByIdAndDelete(idborra,
